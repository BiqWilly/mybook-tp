...
export default function Navbar({
  ...
  // Dashboard only if role is admin
  if (user?.role === "admin") {
    menuItems.push({ name: "Dashboard", icon: "🛠️" });
  }
          ...
          >
            ...
            >
              <path
                ...
                d="M12 12c2.21 0 4-1.79 4-4s-1.79-4-4-4-4 1.79-4 4 1.79 4 4 4zM6 20v-1c0-1.105.895-2 2-2h8c1.105 0 2 .895 2 2v1H6z"
              />
            </svg>
          </button>
        </div>
